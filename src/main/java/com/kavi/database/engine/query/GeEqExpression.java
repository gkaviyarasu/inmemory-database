 ...
 */
public class GeEqExpression implements Expression {
    private final Column column;
    private final Comparable value;

    public GeEqExpression(final Column column, Comparable value) {
        this.column = column;
        this.value = value;
    }
        ...
        while (!nodeQueue.isEmpty()) {
            ...
            switch (Util.nullSafeCompare(root.getValue(), value)) {
                ...
                case 1:
                    ...
                    addToList(tree.inOrder(root.getRight()), result);
